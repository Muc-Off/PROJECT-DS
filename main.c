...
void sample_data()
{
    add_stall(&stalls, stall_id_counter++, "Nescafe", "01700000001");
    add_item(&items, item_id_counter++, "Coffee", 20, 50, 1);
    add_item(&items, item_id_counter++, "Milk Tea", 15, 50, 1);

    add_stall(&stalls, stall_id_counter++, "Hot cake", "01700000002");
    add_item(&items, item_id_counter++, "Cup cake", 50, 50, 2);
    add_item(&items, item_id_counter++, "Muffin", 70, 50, 2);
}
...
int main()
{
    ...
    while (1)
    {
        printf("\n\nEWU E-CANTEEN MANAGEMENT SYSTEM \n\n");
        printf("1. Admin\n");
